...
// 从抓取的目录中获取有效数据
function getMenus ($domMenus, $, len) {
  ...
  return len ? menus.slice(0, len) : menus
}

// const menus = [
//   {
//     url: '111',
//     title: ' 100章 老鼎也顶不住了（五千字，不分章了，算加更吗？'
//   },
//   {
//     url: '111',
//     title: '老鼎也顶不住了（五千字，不分章了，算加更吗？'
//   },
//   {
//     url: '111',
//     title: '第901、902、903章 了却因果'
//   },
//   {
//     url: '111',
//     title: '第一百三十二章 吃了没'
  ...
  if (_menus.length) {
    ...
    for (const i in _menus) {
      ...
      if (index < lastMax) {
        ...
        // 一下子大了10章的，去掉 '第901、902、903章 了却因果' 的情况
        if (lastMax > 0 && index > lastMax + 10) {
          _menus[i].index = 0
        } else {
          lastMax = index
